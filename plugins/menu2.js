...
*NOTE :*
*(Ⓛ) : Fitur yang menggunakan Limit*
*(Ⓟ) : Fitur Khusus PREMIUM*
`
    .trimStart(),
  header: '%category',
  body: '• %cmd %islimit %isPremium',
  after: `Sans. BOTZ masih dalam tahap pengembangan.
`,
}
...
// Tampilkan Tahun Baru
    ...
    let replace = {
      ...
      github: package.homepage ? package.homepage.url || package.homepage : '[unknown github url]', name, weton, week, date, dateIslamic, dateCountdown, wib, wit, wita, time, totalmem, totalreg, rtotalreg, platformInfo, freemem, infomem,
      readmore: readMore
    }
    text = text.replace(new RegExp(`%(${Object.keys(replace).sort((a, b) => b.length - a.length).join`|`})`, 'g'), (_, name) => '' + replace[name])
    await m.reply('Tunggu Sebentar...\nJika BOT tidak merespon coba ketik ulang')
// Fake Contact
...
handler.tags = ['main']
handler.command = /^(allmenu|menu1|help2|\?)$/i
