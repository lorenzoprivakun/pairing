...
let dann = `Hola ${name}\n\n*S A N S. BOTZ* adalah BOT yg membantu membuat sticker, dan memiliki banyak fitur untuk mempermudah hidup klean.\n\nBerikut ini list yang tersedia:\n\n• .allmenu\n• .aimenu\n• .stickermenu\n\n2023 © N A A BOTZ\nBot masih dalam tahap Pengembangan.`
let menu = [
    '😎'
    ]
...
conn.sendFile(m.chat, './dann.mp3', '', null, m, true, { type: "audioMessage", ptt: true, fileLength: 170000 })
}
handler.help = ['menu']
handler.tags = ['main']
