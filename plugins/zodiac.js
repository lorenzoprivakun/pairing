let handler = (m, { usedPrefix, command, text }) => {
    if (!text) throw `Masukan (Tahun) (Bulan) (Hari)\nContoh:\n${usedPrefix + command} 2001 19 26 `
    ...
    const cekusia = bulan === birth[1] && tanggal === birth[2] ? `Selamat ulang tahun yang ke-${age} �戊` : age
...
handler.help = ['zodiak *1999 02 25*']
handler.tags = ['fun']
