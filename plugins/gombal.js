let handler = async (m, { conn, usedPrefix, command }) => {
    await conn.sendButton(m.chat, `“${pickRandom(global.gombal)}”`, '2023 © Lins-MD', 'Gombal', [['Gombal', `${usedPrefix}gombal`], ['Menu', '.menu']], m)
    conn.sendFile(m.chat, './mp3/cie.mp3', '', null, m, true, { type: "audioMessage", ptt: true, fileLength: 88738 })
}
handler.help = ['gombal']
handler.tags = ['quotes']
