...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, wm.trim(), await( await conn.getFile(thumbnail)).data, [['Video', `.ytv ${vid.url}`]], false, { quoted: m, 'document': { 'url':'https://wa.me/+6285876830674' },
...
sourceUrl: 'http://wa.me/+6285876830674', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
