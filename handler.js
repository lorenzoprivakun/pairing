                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                     //   this.reply(m.chat, `Limit anda habis, silahkan beli melalui *${usedPrefix}buy*`, m)
                        this.sendButton(m.chat, `Limit anda habis, ketik .owner lalu hubungi owner untuk mengisi kembali Limit (FREE)`, author, null, [['Buy Limit', '/buyall'], ['Hadiah', '/hadiah']], m)
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            let wel = API(`https://api.lolhuman.xyz/api/base/welcome?apikey=Fairlovely&img1=https://i.postimg.cc/CM34YRFb/photo-2021-02-05-10-13-39.jpg&img2=https://i.postimg.cc/CM34YRFb/photo-2021-02-05-10-13-39.jpg&background=https://i.ibb.co/8B6Q84n/LTqHsfYS.jpg&username=${name}&member=${member}&groupname=${gpname}`)
                            let lea = API(`https://api.lolhuman.xyz/api/base/leave?apikey=Fairlovely&img1=https://i.postimg.cc/CM34YRFb/photo-2021-02-05-10-13-39.jpg&img2=https://i.postimg.cc/CM34YRFb/photo-2021-02-05-10-13-39.jpg&background=https://i.ibb.co/8B6Q84n/LTqHsfYS.jpg&username=${name}&member=${member}&groupname=${gpname}`)
...
`.trim(), m.message)
  ...
  async onCall(json) {
    ...
    if (jid && isOffer) {
      ...
      m.reply(`*BANNED* Minimal baca Rules (.rules)\nHubungi Owner : @${owner[0]} untuk UNBAN`)
    }
  },
